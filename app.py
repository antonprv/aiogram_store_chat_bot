...
# Обработчик команды start, показывает самое первое сообщение бота.
...
❓ Возникли вопросы? Не проблема! Команда /help поможет связаться с админами,
 которые постараются как можно скорее откликнуться.
''', reply_markup=markup)
